...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/fichaProducto.css">
  ...
  <input type="hidden" id="id_user" value="<?php echo $idUser;?>">
      ...
      <div id="content" class="p-0 ">
              ...
              <div class="container">
                ...
                <div class="row pt-4">
                  ...
                  <div class="col-md-3 pl-0 ">
                    ...
                    <a href="../homePage/index.php?usuario=<?php echo $_SESSION['usuario'];?>" class="enlace"><img src="images/logo.png" alt="barras" class ="img-responsive" style="width:230px !important; height:110px !important"></p></a>
                  </div>
                  <?php
        ...
        <div class="container-fluid pt-4">
          <div class="container">
            <div class="row pb-4">
              <ol class="breadcrumb pl-5 pt-4" id= "breadcrumb" style="background-color:white;">
                <li class="breadcrumb-item itembreadcrumb"><a href="../homePage/index.php?usuario=<?php echo $_SESSION['usuario'];?>">Home</a></li>
                <li class="breadcrumb-item itembreadcrumb"><a class="isDisabled">PS4</a></li>
                <li class="breadcrumb-item active itembreadcrumb" id="juego">Final Fantasy VII Remake<!--Seria el juego seleccionado--></li>
              </ol>              
            </div>
            <div class="row">
              <div class="col-lg-5 offset-lg-1">
                <div id="border-image" class="text-center">
                 
                </div>
             
              </div>
              <div class="col-lg-5 offset-lg-1" id="cargaItem">
          
              </div>
            </div>
            <div class="row pt-5 pb-3">
              <div class="col-lg-2 offset-lg-5 text-center pt-4">
                <p id="Galery">GALERIA</p>
              </div>
            </div>
            <div class="row pt-3" id="cargaGaleria">
             
            </div>
            <div class="row pt-5">
              <div class="col-lg-2 offset-lg-5 text-center pt-4">
                <p id="Galery">TRAILER</p>
              </div>
            </div>
            <div class="row pt-3 pl-5">
              <div class="col-lg-6 text-center pl-5" id="cargaTrailer">
                
              </div>
            </div>
            <div class="row pt-5">
              <div class="col-lg-2 offset-lg-5 text-center pt-4">
                <p id="Galery">REVIEWS</p>
              </div>
            </div>
            <div class="row pt-3">
              <div class="col-lg-11">
                <div class="md-form amber-textarea active-amber-textarea">
                  <textarea id="opinion" class="md-textarea form-control" rows="3" placeholder="Introduce tu opinion" ></textarea>
                  <label for="form19"></label>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-2 offset-lg-10 mr-5 pr-5">
               <button type="button" class="botonenviar pt-1 pb-1 pl-3 pr-3 fuente-1" id="sendComment">Enviar</button>
              </div>
            </div>
             <div id="cargaOpiniones">
...
<div class="modal fade" id="pedidosModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content d-block">
      ...
      <div class="modal-body">
      <div id="repetido4" style="color:red;" class="pb-2 pt-2  mb-3 text-center " >          
          </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="realizarPedido4">Realizar pedido</button>
      </div>
    </div>
  </div>
</div>
  ...
  <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="js/fichaProducto.js"></script>
  </body>
</html>