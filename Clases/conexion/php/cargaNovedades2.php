...
//echo 'Estoy en cargaOfertas';
    ...
    $query ="SELECT * FROM videogames WHERE precio >=30 AND precio <=36 LIMIT 4";
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
      ...
      echo '  <div class="col-lg-3 col-md-6 mb-4 text-center" >';
       echo ' <div>';
       echo '<a href="../Login/login.html" class="text-center">';
       ...
       echo '</a>';
          echo '<div class="card-body pt-0 pr-0 pl-0">';
           ...
           echo '<a href="../Login/login.html" class="titlevideogames hvideogames fuente-1"><strong>'.$row['titulo'].'</strong></a></h4>';
