...
function cargaJuegosOfertas(){

    $.ajax({
        url: "../Clases/conexion/php/cargaJuegosOfertas.php",
        method: 'GET',
        success: function (data) {

            console.log(data);
            $("#cargaJuegosOferta").html(data);
...
function cargaJuegosRebajas(){

    $.ajax({
        url: "../Clases/conexion/php/cargaJuegosRebajas.php",
        method: 'GET',
        success: function (data) {
...
function cargaJuegosGenerico(){

    $.ajax({
        url: "../Clases/conexion/php/cargaJuegosGenerico.php?categoria="+categoria,
        method: 'GET',
        success: function (data) {
