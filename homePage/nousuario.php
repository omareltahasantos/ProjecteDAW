...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/nousuario.css">
              ...
              <div class="container">
                ...
                <div class="row pt-4">
                  ...
                  <div class="col-md-2 mr-5 ">
                      ...
                      <span class="paginasCabecera" type="button" ><a href="../Login/login.html" class="enlace fuente-1" id="lanzamiento">Ofertas</a></span>
                  </div>
  
                  <div class="col-md-3 pl-0 ">
                
                    <a href="../homePage/nousuario.php" class="enlace"><img src="../fichaProducto/images/logo.png" alt="barras" class ="img-responsive" style="width:230px !important; height:110px !important"></p></a>
                  </div>
                  <?php
                     if(isset($_GET['usuario'])){
                      $usuario = $_GET['usuario'];
                      $userrol = new user($objPDO);
                      $consulta ="SELECT rol FROM user WHERE nombre ='".$usuario."'" ;
                  ...
                  <div class="col-md-2 ">
                      ...
                      <span class="paginasCabecera" type="button" ><a href="../Login/login.html" class="enlace fuente-1" id="carro">Cesta</a></span>
                  </div>
               </div>
            </div> 
          </div>
            ...
            <nav id="sidebar">
              <div class="p-4 pt-5 ">
                          ...
                          ?>
                           <h4 class="fuente-1">Bienvenido/a <?php echo $_GET['usuario']; ?></h4>
                            <?php
                              ...
                              ?>
                              <h4 class="fuente-1">Bienvenido/a</h4>
                              <?php
                             }
                            ?>
                ...
                <div class="row pl-3 pb-3 ">
                  <div class="col-md-12 ">
                   <a href="../Login/login.html" class="menu-sidebar fuente-1">Ofertas</a>      
                  </div>
                </div>
                <div class="row pl-3 pb-3">
                  <div class="col-md-12 ">
                    <a href="../Login/login.html" class="menu-sidebar fuente-1">Rebajas</a>  
                  </div>
                </div>
                <div class="row pl-3 pb-3">
                  <div class="col-md-12 ">
                    <a href="../Login/login.html" class="menu-sidebar fuente-1">Playstation 4</a>  
                  </div>
                </div>
                <div class="row pl-3 pb-3">
                  <div class="col-md-12 ">
                    <a href="../Login/login.html" class="menu-sidebar fuente-1">Xbox One</a>  
                  </div>
                </div>
                <div class="row pl-3 pb-3">
                  <div class="col-md-12 ">
                    <a href="../Login/login.html" class="menu-sidebar fuente-1">Nintendo Switch</a>  
                  </div>
                </div>
                <div class="row pl-3 pb-3">
                  <div class="col-md-12 ">
                    <a href="../Login/login.html" class="menu-sidebar fuente-1">PC</a>  
                  </div>
                </div>
  ...
  <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="js/nousuario.js"></script>
  </body>
</html>