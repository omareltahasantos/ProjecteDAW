...
function cargaOfertas(){
    ...
    $.ajax({
        url: "../Clases/conexion/php/cargaOfertas2.php",
        method: 'GET',
...
function cargaNovedades(){
    ...
    $.ajax({
        url: "../Clases/conexion/php/cargaNovedades2.php",
        method: 'GET',
        success: function (data) {
...
function cargaRecomendados(){
    ...
    $.ajax({
        url: "../Clases/conexion/php/cargaRecomendados2.php",
        method: 'GET',
        success: function (data) {
...
function cargaProximamente(){
    ...
    $.ajax({
        url: "../Clases/conexion/php/cargaProximamente2.php",
        method: 'GET',
        success: function (data) {
