...
if(isset($_GET['id_juego'])&& isset($_GET['foto'])){
  
  $galeria = new galeria($objPDO);
  $consulta="INSERT galeria (id_juego,filename) VALUES ($_GET[id_juego],'$_GET[foto]')";

  if ( $resultado = $galeria->insertGaleria($consulta)){
