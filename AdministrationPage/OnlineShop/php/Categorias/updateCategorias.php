...
if(isset($_GET['id_categoria']) && isset($_GET['category'])){
    
   // updateVideogame
    $categoria = new categoria($objPDO);
    $consulta="UPDATE categoria SET nombre ='".$_GET['category']."' WHERE id_categoria = '".$_GET['id_categoria']."'" ;
...
if ($resultado = $categoria->updateCategoria($consulta)){
