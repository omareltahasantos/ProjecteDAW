            ...
            <div class="row m-3">
             ...
             <div class="row pl-3 h-100 justify-content-center align-items-center">
              ...
              <div class="row">
                ...
                <div class="row pl-3 h-100 justify-content-center align-items-center pb-3 pt-3">
                <div class="col-md-6" id="mensajeErrorUpdateTitulo" style="color:red;">
              
                </div>
              </div>
              <div class="row pl-3 h-100 justify-content-center align-items-center pb-3 pt-3">
                <div class="col-md-6" id="mensajeErrorUpdatePrecio" style="color:red;">
              
                </div>
              </div> 
              <div class="row pl-3 h-100 justify-content-center align-items-center pb-3 pt-3">
                <div class="col-md-6" id="mensajeErrorUpdateStock" style="color:red;">
