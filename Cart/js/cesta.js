...
$(document).on("click",".Eliminar",function(){
    ...
    $.ajax({
        method: 'GET',
        url: "../Clases/conexion/php/removeItem.php?id_juego="+id,
        success: function(data) {
           console.log(data);
            if(data==="bien"){
                $("#mensajeEliminar").html("El articulo se ha eliminado correctamente!");
              
                $.ajax({
                    method: 'GET',
                    url: "../Clases/conexion/php/cargaCesta.php",
                    success: function(data) {
                        $("#cargaCesta").html(data);
