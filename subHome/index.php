...
<html lang="en">
  ...
  <div class="container-fluid pt-4">
    <div class="container" >
      <div id="categoriaSub"></div>
    </div> 
  </div>
  <div class="container-fluid pt-4 " >
    <div class="container" >
      <div class="row pt-2 pr-5 mr-5 contenedor" id="cargaJuegosOferta">
...
<div class="modal fade" id="pedidosModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content d-block">
      ...
      <div class="modal-body">
      <div id="repetido2" style="color:red;" class="pb-2 pt-2  mb-3 text-center " >          
          </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="realizarPedido2">Realizar pedido</button>
      </div>
    </div>
  </div>
</div>
  ...
  <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="js/subhome.js"></script>
  </body>
</html>